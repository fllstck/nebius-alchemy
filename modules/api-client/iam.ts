...
import * as NebiusStaticKeyServiceSchema from '../../schemas/nebius/iam/v1/static_key_service.ts'
import type { StaticKey } from '../../schemas/nebius/iam/v1/static_key.ts'
import * as NebiusAccessKeyV1ServiceSchema from '../../schemas/nebius/iam/v1/access_key_service.ts'
import type { AccessKey } from '../../schemas/nebius/iam/v1/access_key.ts'
import * as NebiusAccessKeyV2Schema from '../../schemas/nebius/iam/v2/access_key.ts'
import * as NebiusAccessKeyV2ServiceSchema from '../../schemas/nebius/iam/v2/access_key_service.ts'
import * as NebiusFederationSchema from '../../schemas/nebius/iam/v1/federation.ts'
import * as NebiusFederationServiceSchema from '../../schemas/nebius/iam/v1/federation_service.ts'
import * as NebiusFederationCertSchema from '../../schemas/nebius/iam/v1/federation_certificate.ts'
import * as NebiusFederationCertServiceSchema from '../../schemas/nebius/iam/v1/federation_certificate_service.ts'
...
import * as NebiusFedCredsServiceSchema from '../../schemas/nebius/iam/v1/federated_credentials_service.ts'
...
import * as NebiusInvitationServiceSchema from '../../schemas/nebius/iam/v1/invitation_service.ts'
