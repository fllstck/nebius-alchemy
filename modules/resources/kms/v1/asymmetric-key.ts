...
import * as NebiusAsymmetricKeySchema from '../../../../schemas/nebius/kms/v1/asymmetric_key'
...
export const NebiusAsymmetricKeyProvider = AlchemyProvider.succeed(NebiusAsymmetricKey, {
